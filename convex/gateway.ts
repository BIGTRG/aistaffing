  ...
  handler: async (ctx) => {
    const connectors = [
      ...
      },
      {
        ...
        baseUrl: "https://api.youknownow.ai",
        authType: "api_key",
        description: "AI background checks & risk scoring — criminal, employment, education, credit, identity verification",
        capabilities: ["criminal_check", "employment_verify", "education_verify", "credit_check", "identity_verify", "drug_screening", "risk_scoring", "continuous_monitoring"],
        isActive: true,
        requestCount: 0, lastUsedAt: undefined, avgLatencyMs: 0, errorRate: 0,
      },
      {
      ...
      // ─── New TRG Product Integrations ───
      {
        name: "Stewart Solution",
        slug: "stewart-solution",
        type: "hr",
        baseUrl: "https://api.stewartsolution.com",
        authType: "api_key",
        description: "HR platform — recruitment, employee onboarding, workforce management, compliance tracking",
        capabilities: ["post_job", "screen_applicant", "onboard_employee", "manage_benefits", "track_compliance", "generate_offer_letter", "performance_review", "termination_workflow"],
        isActive: true,
        requestCount: 0, lastUsedAt: undefined, avgLatencyMs: 0, errorRate: 0,
      },
      {
        ...
        slug: "stewart-money",
        type: "finance",
        baseUrl: "https://api.stewartmoney.com",
        authType: "api_key",
        description: "Bookkeeping & payroll — invoicing, expense tracking, payroll processing, financial reporting, tax prep",
        capabilities: ["create_invoice", "process_payroll", "track_expenses", "generate_reports", "tax_filing", "bank_reconciliation", "accounts_receivable", "accounts_payable"],
        isActive: true,
        requestCount: 0, lastUsedAt: undefined, avgLatencyMs: 0, errorRate: 0,
      },
      {
        ...
        type: "email_platform",
        baseUrl: "https://api.geniuseye.ai",
        authType: "api_key",
        description: "Business email platform — custom domain email accounts, AI-native inbox, send/receive through AI agents",
        capabilities: ["create_mailbox", "send_email", "receive_email", "custom_domain", "ai_compose", "ai_sort", "spam_filter", "email_forwarding", "shared_inbox"],
        isActive: true,
        requestCount: 0, lastUsedAt: undefined, avgLatencyMs: 0, errorRate: 0,
      },
    ];
